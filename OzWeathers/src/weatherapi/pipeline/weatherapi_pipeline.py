...
def run_pipeline():
    ...
    try: 
        ...
        # node_serving_sales_customer = Transform(model="serving_sales_customer", engine=target_engine, models_path=path_transform_model)
        # node_serving_sales_cumulative = Transform(model="serving_sales_cumulative", engine=target_engine, models_path=path_transform_model)
