...
class Extract():
    ...
    # def extract_from_api (self, table_name, key, bucket:str=None, filename:str=None, aws_accessid:str=None, awssecretkey:str=None, regionname:str=None)->pd.DataFrame:
...
#this extract forecast data for the next 7 days
    ...
    @staticmethod
    def extract_from_api (table_name, key, bucket:str=None, filename:str=None, aws_accessid:str=None, awssecretkey:str=None, regionname:str=None)->pd.DataFrame:
        print('Inside extract_from_api')
        try:
