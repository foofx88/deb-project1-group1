...
class Load():
    ...
    def __init__(self, df:pd.DataFrame, engine:str, table_name:str, load_method:str, chunksize:int=500, key_columns:list=None):
        self.df=df
    ...
    def _upsert_to_database(self, df: pd.DataFrame, table_name: str, key_columns: str, engine, chunksize:int=1000)->bool: 
        """
