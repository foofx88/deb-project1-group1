...
class Transform():
    ...
    def run(self)->bool:
        ...
        - `model`: the name of the model without the '.sql' extension
        - `models_path`: the path to the models directory containing the sql files for transforming. Defaults to `models`
        """
